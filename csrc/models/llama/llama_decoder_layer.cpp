...
LlamaDecoderLayer::forward(infinicore::Tensor &hidden_states,
    ...
    // 2. Self-attention
    hidden_states = self_attn_->forward(hidden_states, position_ids, kv_cache, past_sequence_lengths, total_sequence_lengths, input_offsets, block_tables, slot_mapping, mate_workspace_buffer, mtt_tasks);
